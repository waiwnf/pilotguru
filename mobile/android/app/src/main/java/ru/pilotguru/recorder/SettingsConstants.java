...
public class SettingsConstants {
  ...
  public static final String PREF_FIX_ISO = "pref_fix_iso";
  public static final String PREF_AUTOFOCUS = "pref_autofocus";
  public static final String PREF_EIS = "pref_eis";
  public static final String PREF_OIS = "pref_ois";
